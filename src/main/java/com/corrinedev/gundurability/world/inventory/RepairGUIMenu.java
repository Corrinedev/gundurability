...
public class RepairGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RepairGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GundurabilityModMenus.REPAIR_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 152, 10) {
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 80, 10) {
